...
mixin _$HomeState<T> {
  ...
  TResult when<TResult extends Object?>({
    ...
    required TResult Function(GetNewsResponse data) success,
  ...
  TResult? whenOrNull<TResult extends Object?>({
    ...
    TResult? Function(GetNewsResponse data)? success,
...
abstract class Success<T> implements HomeState<T> {
  const factory Success(final GetNewsResponse data) = _$SuccessImpl<T>;

  GetNewsResponse get data;
